...
<div class="d-flex flex-column flex-shrink-0 p-4 bg-white shadow-sm" style="width: 260px; height: 100vh; position: fixed; z-index: 1000;">
    ...
    <ul class="nav nav-pills flex-column mb-auto gap-2">
        ...
        <li>
            <a href="penghasilan.php" class="nav-link fw-semibold <?php echo ($halaman_sekarang == 'penghasilan.php') ? 'active text-white" style="background-color: #1E3A8A; border-radius: 10px;"' : 'link-dark"'; ?>">
                Penghasilan
            </a>
        </li>
        <li>
            <a href="siswa.php" class="nav-link fw-semibold <?php echo ($halaman_sekarang == 'siswa.php') ? 'active text-white" style="background-color: #1E3A8A; border-radius: 10px;"' : 'link-dark"'; ?>">
                Siswa Saya
            </a>
        </li>
        <li>
