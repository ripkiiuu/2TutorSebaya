...
$q_mentor = mysqli_query($conn, "SELECT id_mentor FROM mentor WHERE id_user='$id_user'");
$id_mentor = mysqli_fetch_assoc($q_mentor)['id_mentor'];

// Ambil daftar mahasiswa yang pernah mem-booking mentor ini
            ...
            <div class="row g-0 h-100">
                <div class="col-md-4 border-end bg-white h-100 overflow-auto">
                    <div class="p-3 border-bottom bg-light">
                        <h5 class="fw-bold mb-0" style="color: #1E3A8A;"><i class="bi bi-chat-dots"></i> Kotak Masuk</h5>
                    </div>
